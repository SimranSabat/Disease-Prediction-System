...
from disease_prediction_system.utils import getDropDown, dictfetchall
...
def add(request):
    ...
    if (request.method == "POST"):
        ...
        messages.add_message(request, messages.INFO, "Your account registered successfully. Login to your account !!!")
